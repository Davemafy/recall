...
export const JOHNSON_DUNN_DEPENDENCIES=[
  dependency({
    ...
    incidentEvidence:{
      ...
      pdfPageNumber:4,
      sha256:'4de0f3271e6ff3ec9291f8b87f5a915ca1cc8bf3e00e68747b951500ef19e312',
      sourceUrl:JOHNSON_DUNN_ORDER_URL
    },
  ...
  dependency({
    ...
    reviewStatus:INCIDENT_REVIEW_STATUS.CONFIRMED_FROM_INCIDENT_SOURCE,
    incidentEvidence:{
      exactText:'Defendant Dunn cited “Kelley v. City of Birmingham, 2021 WL 1118031, *2 (N.D. Ala. Mar. 24, 2021)” for the proposition that the district court “refus[ed] to delay deposition based on unrelated discovery issues.” Doc. 174 at 2.',
      pdfPageNumber:4,
      sha256:'d6ea0c826ae0a88713ddc95edff50be6b4981e318affee7c3dd782e1879da11e',
      sourceUrl:JOHNSON_DUNN_ORDER_URL
    },
  ...
  dependency({
    ...
    incidentEvidence:{
      ...
      pdfPageNumber:5,
      sha256:'3cf66994b3d1f102886a8f673fe7fa0740083d5ce3f168a577a6888a70d73c40',
      sourceUrl:JOHNSON_DUNN_ORDER_URL
    },
