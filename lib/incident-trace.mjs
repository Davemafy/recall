...
export async function traceIncidentDependencies(dependencies,token,{maxCandidatesPerDependency=10,traceFn=traceCourtListener,firecrawlKey=process.env.FIRECRAWL_API_KEY||'',signal=null,onProgress=null}={}){
  ...
  for(let index=0;index<dependencies.length;index++){
    ...
    statuses.push({dependencyId:dependency.id,state:'searching',retryAfterMs:null,checked:0,confirmed:0});
